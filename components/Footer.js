...
export default function Footer() {
  return (
    <footer className="relative mt-20 py-20 overflow-hidden">
      ...
      ></div>
      {/* Sötétítő réteg, hogy a szöveg jobban olvasható legyen */}
      ...
      >
        ...
        <p className="mt-4 text-muted-foreground">
          Köszönjük, hogy velünk ünnepelsz ezen a csodálatos napon.
        </p>
        ...
        <div className="mt-10 border-t border-border pt-8">
          ...
          <p className="mt-6 text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} Viktória & Tomi. Minden jog fenntartva.
          </p>

          {/* ÚJ SZEKCIÓ: A te adataiddal */}
          <div className="mt-8 border-t border-border/50 pt-6 text-xs text-muted-foreground">
            <p>
              Az oldalt készítette: <span className="font-semibold">Kovács Bálint</span>
            </p>
            <div className="mt-2 flex justify-center items-center gap-x-4">
              <a href="mailto:kapcsolat@kovacsbalintfoto.hu" className="hover:text-foreground transition-colors">
                kapcsolat@kovacsbalintfoto.hu
              </a>
              <span>&bull;</span>
              <a href="tel:+36308723777" className="hover:text-foreground transition-colors">
                +36 30 872 3777
              </a>
            </div>
          </div>
