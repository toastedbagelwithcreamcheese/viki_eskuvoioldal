...
export default function Venue() {
  ...
  return (
    // A szekciónak nincs háttérszíne, hagyja érvényesülni a body hátterét
    <section className="py-20 bg-gradient-to-b from-background to-muted/20">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        >
          {/* A font-heading-et a CSS automatikusan alkalmazza a h2-re */}
          <h2 className="text-4xl md:text-5xl text-foreground">A Nagy Nap Helyszíne</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 mt-16 items-center">
          ...
          <motion.div
            ...
            // ÚJ KÁRTYA STÍLUSOK ALKALMAZÁSA
          ...
          >
            <div className="mb-8">
              ...
              <p className="text-card-foreground font-bold">Etyeki Czímeres Birtok</p>
              <p className="text-muted-foreground">2091 Etyek, Sóskúti út</p>
            </div>
